...
// 正常按钮样式
#define NORMAL_BUTTON_STYLE  "QPushButton { font: 14px; border-radius: 10px; background-color:rgba(115, 129, 255, 1); color: #EAEAEA;}  QPushButton:hover {font: 14px; background-color:rgba(141, 153, 255, 1); color: #EAEAEA;} QPushButton:pressed {font: 14px; background-color:rgba(79, 92, 203, 1); color: #EAEAEA;} QPushButton:checked {font: 14px; background-color:rgba(79, 92, 203, 1); color: #EAEAEA;}"
